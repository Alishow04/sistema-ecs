...
export function createCombobox({
  ...
  container.innerHTML = `
    <div class="combobox__control">
      ...
      <button type="button" class="combobox__toggle" aria-label="Abrir opções" title="Abrir opções" tabindex="-1"><span class="combobox__chevron" aria-hidden="true"></span></button>
    </div>
  ...
  function updateAffordances() {
    clearBtn.hidden = !showClearButton || !(currentValue || input.value) || input.disabled;
