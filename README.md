...
2. Relatórios e gráficos, exportação PDF e CSV
3. Configurações (edição das listas de `settings/*` pela própria interface)
4. Acabamento visual e segurança adicional (Firebase App Check, por
