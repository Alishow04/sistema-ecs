...
- Novo ECS (Cliente, Solicitante, Vendedor, Filial/Região, UF automática,
  Produto, Marca, Data, Observações), com **painel "Últimos ECS" ao lado**
...
- **Configurações** — edita as 5 listas de apoio (Responsáveis, Filiais,
  Vendedores, Produtos, Marcas) direto pela interface, sem abrir o console
  do Firebase. Responsáveis nunca é removido, só ativado/desativado (o
  código é permanente); os demais são chips com um "×" para remover.
  Mudanças aparecem na hora nas outras telas (combobox de Novo ECS, filtros
  do Histórico), sem precisar recarregar a página.
